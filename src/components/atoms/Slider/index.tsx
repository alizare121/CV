    ...
    return (
        <div className="ml-8 flex h-full">
            ...
            <div className="flex flex-col justify-between items-center my-8 relative">
                ...
                {
                    data.map(({ title, id }) => {
                        return <div className="w-12 h-12 z-20 shadow rounded-full bg-white items-center justify-center flex cursor-pointer hover:scale-110 hover:bg-indigo-700 duration-300" key={id}>
